...
describe('manifestPatterns', () => {
  it('derives globs from the declared members, so a new member area is read', () => {
    expect(manifestPatterns(['packages/*/*', 'tools/*', 'packages/native/landlock-run', 'packages/native/landlock-run/packages/*'])).toEqual([
      'package.json',
      'packages/*/*/package.json',
      'tools/*/package.json',
      'packages/native/landlock-run/package.json',
      'packages/native/landlock-run/packages/*/package.json',
