 ...
 * (`docker/support/scripts/gen-persistence-catalog.ts`).
 */
...
import {
  ...
  render,
} from '../../../../docker/support/scripts/gen-persistence-catalog.ts'
...
describe('gen-persistence-catalog annotateSurface + render', () => {
  ...
  it('renders badges, declaration fences, and the generated-file header', () => {
    ...
    expect(out).toContain('Generated by docker/support/scripts/gen-persistence-catalog.ts')
