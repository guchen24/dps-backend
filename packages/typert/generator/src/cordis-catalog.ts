...
function renderRuntimeApi(
  ...
  const lines: string[] = [
    '/**',
    ' * Generated by docker/support/scripts/gen-cordis-api.ts — do not edit by hand; run',
